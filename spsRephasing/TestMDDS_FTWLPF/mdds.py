...
class mdds(object):
        ...
        def read_settings(self):
                ...
                print 'Test mode SWG  = ', hex(self.m.mddsControl & 0x0040)
                ...
                print ''
                print 'LinInterp. Ena = ', hex(self.m.mddsControl & 0x0020) #bit5
                print 'LinIn. err50us = ', hex(self.m.mddsFaults & 0x0040) #bit6
                print 'LinIn. errCnt  = ', hex(self.m.mddsDbgCntStr1us)
                print 'LinIn. ovf     = ', hex(self.m.mddsFaults & 0x0020) #bit5
                print ''
