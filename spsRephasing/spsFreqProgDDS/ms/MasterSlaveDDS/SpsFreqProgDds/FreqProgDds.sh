...
#  Command=$MasterSlot"00012 1 0800"
#  writevme $Command

echo Select Serial IN FP
  Command=$MasterSlot"00012 1 0808"
  writevme $Command
...
echo IO_Update DDS
 ...
 echo CFR init 0000 0011 0000 0001 full scale bits [9..8] sinus on bit [0]
  ...
  writevme $Command
 echo CTW0 init
  Command=$MasterSlot"00040 3 1999 9999 0004"
  writevme $Command
...
echo Read Serial FTW Register 32 bits
