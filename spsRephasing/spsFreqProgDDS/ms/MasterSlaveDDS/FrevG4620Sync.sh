...
# H=120C for SPS 200MHz (4620)
# H0=2000 for MAsterDDS (2^13 is 8192)
#                   B2   B1   B0   H2   H1   H0   W1   W0
command=$1"0003a 8 0000 0000 0300 0000 0000 120C 0000 0000"
...
writevme $command
#
#Write control register 0 (1st NoSync control bit) 2015.10.19 changed to sync
#command=$1"00000 1 0101"
command=$1"00000 1 0100"
writevme $command
#Write control register 0 (2nd NoSync control bit)
#command=$1"0000A 1 2020"
command=$1"0000A 1 2000"
writevme $command
#
