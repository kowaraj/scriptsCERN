...
# Add the following to FESA Write Harware
echo Set FrevSyncSel to FP
...
echo "FSK Frequency on DDS Channel 0, FP Output is RF2"
echo CSR channel 0 select reg on bits [7..4]:0001
echo CH0 only 0001 0000  0x00000010
  Command=$SlaveSlot"00048 3 0000 0010 0000"
  writevme $Command


echo FR1 init 4-Level Modulation bits [9,8]:01, Profile Pins Config [14..12]:000 can only work with 2 channels so we chose channel 0 channel 1.
...
echo 0000 0000 0000 0000 0000 0001 0000 0000 4 level
 ...
 echo CFR init 1000 0000 0000 0000 0011 0000 0000 hex 0080 0300 cosinus [0], DAC full scale [9,8]:11, Freq Modulation [23,22]:10
 echo only P0 and P1 will be used for CH0, P2 and P3 stay GND for CH1 Average freq channel
...
echo "Average Frequency on DDS Select Channel 1, FP Output is RF1 in ppcrf19, channel 2 in BA3"
...
echo "Autoclear Phase Accus check, if channels select not needed"
