...
#  Usage:
#  -----
#  rfs@cfv-864-agsps 836 $ ./sDDS.sh 6 3 "7000 0000" "6800 0000"
#  where: slot=6, selected channels are 0 and 1, FTW0 = 70..., FTW1=68....
# '
...
sleep 0.2
#set FTWm3
# Command="writevme "$Slot"00040 3 "$FTW1" 000B"
# echo "FTWm2   : " $Command
# $Command
# sleep 0.2
# Command="writevme "$Slot"00046 1 0404"
...
# sleep 0.2
# #set FTWm4
# Command="writevme "$Slot"00040 3 "$FTW2" 000C"
# echo "FTWm2   : " $Command
# $Command
# sleep 0.2
# Command="writevme "$Slot"00046 1 0404"
