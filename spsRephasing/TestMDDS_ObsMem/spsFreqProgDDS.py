...
class VMEMapping(object):
    ...
    def readMem(self, offset, n):
        ...
        address = self.pointer(offset, ctypes.c_uint)
        return [address[i] for i in range(n)]
...
class Module(object):
    ...
    @property
    def mddsSerDesGain(self):
        return self.mapping.read_u32(0x20c)

    @mddsSerDesGain.setter
    def mddsSerDesGain(self, value):
        self.mapping.write_u32(0x20c, value)

    @property
    def mddsSerDesOffset(self):
        return self.mapping.read_u32(0x210)

    @mddsSerDesOffset.setter
    def mddsSerDesOffset(self, value):
        self.mapping.write_u32(0x210, value)
    ...
    def mddsDbgPhErr(self):
        return self.mapping.read_u32(0x216)

    @property
    def mddsDbgCFP(self):
        return self.mapping.read_u16(0x21a)

    @property
    def mddsDbgCFPFTW(self):
        return self.mapping.read_u32(0x21c)

    @property
    def mddsFTW(self):
        return self.mapping.read_u32(0x220)

    @property
    def mddsPowLevClk125(self):
        return self.mapping.read_u16(0x224)

    @property
    def mddsFaults(self):
        return self.mapping.read_u16(0x226)

    @property
    def mddsStatus(self):
        return self.mapping.read_u16(0x228)

    @property
    def mddsControl(self):
        return self.mapping.read_u16(0x22a)

    @mddsControl.setter
    def mddsControl(self, value):
        self.mapping.write_u16(0x22a, value)

    @property
    def mddsLPFControl(self):
        return self.mapping.read_u16(0x22c)

    @mddsLPFControl.setter
    def mddsLPFControl(self, value):
        self.mapping.write_u16(0x22c, value)

    @property
    def mddsLPFControl2(self):
        return self.mapping.read_u16(0x22e)

    @mddsLPFControl2.setter
    def mddsLPFControl2(self, value):
        self.mapping.write_u16(0x22e, value)

    @property
    def mddsLPFTestFTW1(self):
        return self.mapping.read_u32(0x230)

    @mddsLPFTestFTW1.setter
    def mddsLPFTestFTW1(self, value):
        self.mapping.write_u32(0x230, value)

    @property
    def mddsLPFTestFTW2(self):
        return self.mapping.read_u32(0x234)

    @mddsLPFTestFTW2.setter
    def mddsLPFTestFTW2(self, value):
        self.mapping.write_u32(0x234, value)

    @property
    def mddsTestFTW1(self):
        return self.mapping.read_u32(0x238)

    @mddsTestFTW1.setter
    def mddsTestFTW1(self, value):
        self.mapping.write_u32(0x238, value)

    @property
    def mddsTestFTW2(self):
        return self.mapping.read_u32(0x23c)

    @mddsTestFTW2.setter
    def mddsTestFTW2(self, value):
        self.mapping.write_u32(0x23c, value)

    @property
    def mddsTestTs(self):
        return self.mapping.read_u32(0x240)

    @mddsTestTs.setter
    def mddsTestTs(self, value):
        self.mapping.write_u32(0x240, value)

        #@property
    def mddsVP(self, size):
        return self.mapping.readMem(0x80000, size)
