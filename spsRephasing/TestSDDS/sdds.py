...
class sdds(object):
        ...
        def status(self):
                ...
                print 'debugFTW2p =      ', hex(self.m.debugFTW2p)
        ...
        def controls(self):
                ...
                print 'ddsControl.h4653       = ', hex(self.m.ddsControl & 0x0020)
        ...
        def vme_selps_ctw_x(self, x):
                m.ddsControl2 = (0xff00 | x)

        def vme_do_io_upd(self):
                m.ddsControl = 0x0202
